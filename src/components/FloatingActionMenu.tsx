...
export function FloatingActionMenu() {
  ...
  return (
    <>
      {(open || animating === "leaving") && (
        <div
          className="fixed inset-0 z-40 flex md:hidden"
          onClick={closeMenu}
        >
          <div className="flex-1 glass-overlay-premium" />
        </div>
      )}
      <div
            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium transition-smooth ${
                    active
