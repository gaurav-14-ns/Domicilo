  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        {[
          { icon: Wallet, label: "Outstanding dues", value: formatINR(outstanding), note: outstanding > 0 ? "Due this month" : "All clear" },
          { icon: Receipt, label: "Last payment", value: lastPayment ? formatINR(lastPayment.amount) : "—", note: lastPayment?.date ?? "No payments yet" },
